...
print("          =========================[กติกา]=========================")
print("『")
print("        1.  เริ่มมาคุณจะมีโอกาสได้ทาย3รอบ")
print("        2.  ทายว่าไพ่ใบต่อไปจะสูงหรือต่ำจากไพ่ที่แสดงอยู่ 1 = สูงกว่า, 0 = ต่ำกว่า")
print("        3.  หากชนะจะได้โอกาสทายเพิ่ม1โอกาส แต่ถ้าแพ้จะเสีย1โอกาส และเสมอจะได้เล่นต่อ")
print("        4.  ถ้าโอกาสเท่ากับศูนย์ จะเกมส์โอเวอร์และแสดงรวมคะแนนที่คุณทำได้ออกมา GLHF")
print("                                                                           』")
